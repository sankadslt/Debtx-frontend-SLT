  ...
  const menuItems = [
      ...
      subItems: [
        {
          ...
          link: "/pages/Distribute/DistributionPreparationBulkUpload",
          roles: ["superadmin", "admin"],
        },
        {
          icon: CgEditFade,
...

    {
      ...
      subItems: [
        ...
        {
          icon: CgEditFade,
          label: "DRC - Mediation Board List",
          roles: ["superadmin", "admin"],
          link: "/MediationBoard/MediationBoardCaseList",
        },
        // { icon: CgEditFade, label: "FTL LOD", link: "/dashboard", roles: ["superadmin", "admin"] },
        // { icon: CgEditFade, label: "Digital Signature LOD", link: "/dashboard", roles: ["superadmin", "admin"] },
      ...
      subItems: [
        {
          icon: CgEditFade,
          label: "Settlement ",
          link: "/pages/Settlement/MonitorSettlement",
          roles: ["superadmin", "admin"],
        },
        {
          icon: CgEditFade,
      ...
      subItems: [
        {
          icon: CgEditFade,
          label: "Request List",
          link: "/additional_request_log",
          roles: ["superadmin", "admin"],
        },
        {
          icon: CgEditFade,
          label: "Request Log",
          link: "/drs/logs/reuest-response-logs",
          roles: ["superadmin", "admin"],
        },
      ],
    },
      ...
      subItems: [
        {
          ...
          link: "/pages/Rtom/RtomList",
          roles: ["superadmin"],
        },
        {
          icon: CgEditFade,
          label: "Service List",
          link: "/pages/Service/ServiceTypeList",
          roles: ["superadmin"],
        },
...

    {
      icon: MdDownload,
      label: "Download",
      link: "/incident/Incident_File_Download",
      roles: ["superadmin", "admin", "user"],
    },
    // {
    //   icon: BiSolidDiamond,
    ...
    return (
      <ul className={`ml-8 mt-2 space-y-2 ${!isHovered ? "hidden" : ""}`}>
        {subItems.map((subItem, subIndex) => {
          ...
          const isAccessible = subItem.roles
                ...
                >
                  <div className="flex items-center gap-x-2">
                    {subItem.icon ? (
                      ...
                      <CgEditFade className="w-4 h-4 text-white" />
                    )}
                    {subItem.label}
                  </div>
                  {subItem.subItems &&

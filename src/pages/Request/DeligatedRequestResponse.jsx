...
const DeligatedRequestResponse = () => {
  ...
  const callAPI = async (filters) => {
    ...
    try {
      setIsLoading(true);
      const response = await List_Deligated_Request_Response(payload);
  ...
  return (
    <div className={GlobalStyle.fontPoppins}>
      ...
      <h1 className={`${GlobalStyle.headingLarge} mb-8`}>Deligated Request Response</h1>
...
export default DeligatedRequestResponse;

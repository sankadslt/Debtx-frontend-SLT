...
export default function Dispute_Letter_Change_Details() {
    return (
        <>
            {/* Form */}
                    ...
                    <form className="w-full max-w-4xl mx-auto">
                        <table className={GlobalStyle.table}>
                            ...
                            <tbody>
                                {/* Field Rows */}
                                <tr>
                                    <td className={GlobalStyle.tableData}>Ref :</td>
                                ...
                                <tr>
                                    <td className={GlobalStyle.tableData}>Send Date :</td>
                                    <td className={GlobalStyle.tableData}>
                                        <input type="text" className={`${GlobalStyle.inputText} w-full`} />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td className={GlobalStyle.tableData}>Telephone No :</td>
                                    <td className={GlobalStyle.tableData}>
                                        <input type="text" className={`${GlobalStyle.inputText} w-full`} />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td className={GlobalStyle.tableData}>Letter Date :</td>
                                    <td className={GlobalStyle.tableData}>
                                        <input type="text" className={`${GlobalStyle.inputText} w-full`} />
                                    </td>
                                </tr>

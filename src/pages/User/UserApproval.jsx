...
// // Mofilfied by: Nimesh Perera (nimeshmathew999@gmail.com), sasindusrinayaka (sasindusrinayaka@gmail.com)
// // Version: node 20
// // ui number :17.3
...
//               created_on: new Date(approval.created_on).toLocaleDateString("en-GB"),
//               drc_id: approval.DRC_id,
//               parameters_user_id: approval.Parameters?.user_id,  // For approval/rejection
//             }));
//             if (filters.page === 1) {
//               // Replace on first page
//               return mappedData;
...
//   // Approve / Reject
//   const approveSelectedUsers = async (userId, drcId) => {  // Note: drcId not used, but kept for consistency
...
//     try {
//       const response = await User_Approval({
//         user_id: Number(userId),  // Ensure integer
//         conf_type: "accept",
//         conf_by: Number(confBy),  // Ensure integer if needed
//       });

//       console.log("API Response:", response);
//       Swal.fire({
//         title: "Approved",
//         text: `User approval processed successfully.`,
//         icon: "success",
//         confirmButtonColor: "#28a745",
//       });
//       window.location.reload();
...
//   const rejectSelectedUsers = async (userId, drcId) => {  // Note: drcId not used, but kept for consistency
//     const confBy = await getLoggedUserId();
//     if (!confBy) {
//       Swal.fire({
//         title: "Error",
...
//       Swal.fire({
//         title: "Success",
//         text: `User approval rejected successfully.`,
//         icon: "success",
//         confirmButtonColor: "#28a745",
//       });
//       window.location.reload();

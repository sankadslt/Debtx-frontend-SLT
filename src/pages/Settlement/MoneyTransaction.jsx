/*Purpose: This template is used for the 7.7 Sup - Money Transaction page.
Created Date: 2025-14-03
Created By: Susinidu Sachinthana (susinidusachinthana@gmail.com)
Last Modified Date: 2025-14-03
Modified Date: 2025-14-03
...
//   const currentData = getSearchedData().slice(startIndex, endIndex);
  ...
  return (
    <div className={`p-4 ${GlobalStyle.fontPoppins}`}>
      ...
      {/* Filters - Single Row */}
      <div className="flex flex-wrap items-center gap-2 mb-4 mt-10">
        <select
          value={selectValue}
      ...
      {/* Pagination */}
      {getSearchedData().length > rowsPerPage && (
...
export default Money_Transactions;

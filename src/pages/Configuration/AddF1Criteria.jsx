...
const AddF1Criteria = () => {
  ...
  const handleSubmit = (e) => {
    ...
    Swal.fire({
      ...
      navigate("/pages/Configuration/F1Criteria"); // Redirect to F1 Criteria list
    });
  };

  const handleCancel = () => {
    navigate("/pages/Configuration/F1Criteria"); // Redirect back to F1 Criteria list
  };
                ...
                <tr className="block md:table-row mb-2">
                  ...
                  <td className="block md:table-cell md:w-2/3 pb-2">
                    ...
                    >
                      ...
                      <option value="Credit Class ID">Credit Class ID</option>
                      <option value="Credit Class Name">Credit Class Name</option>

...
const F1CriteriaEdit = () => {
  ...
  const handleSave = async () => {
    ...
    Swal.fire({
      title: "Success",
      text: "F1 Criteria updated successfully!",
      icon: "success",
      confirmButtonColor: "#3085d6",
    }).then(() => {
      navigate("/pages/Configuration/F1CriteriaInfo", { state: { criteria_id } });
    });
    // }
  };
  ...
  return (
    <div className="p-2 flex items-start justify-center h-screen">
      <div className={`${GlobalStyle.fontPoppins} w-full max-w-5xl`}>
        <h1 className={GlobalStyle.headingLarge}>Edit F1 Criteria</h1>

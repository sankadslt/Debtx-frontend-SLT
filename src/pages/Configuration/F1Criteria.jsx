...
const F1Criteria = () => {
  ...
  const handleAddNew = () => navigate("/pages/Configuration/AddF1Criteria");
  ...
  return (
    <div className={`${GlobalStyle.fontPoppins} px-4 sm:px-6 lg:px-8`}>
      <h2 className={GlobalStyle.headingLarge}>F1 Criteria</h2>

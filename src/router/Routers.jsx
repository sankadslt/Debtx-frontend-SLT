...
import AddF2Criteria from "../pages/Configuration/AddF2Criteria";
...
const Routers = () => {
  return (
    <Routes>
      ...
      <Route
        path="/pages/Configuration/AddF1Criteria"
        element={
          <ProtectedRoute
            element={<AddF1Criteria />}
            allowedRoles={["superadmin"]}
          />
        }
      />
      ...
      <Route
        path="/pages/Configuration/F1CriteriaInfo"
        element={
          <ProtectedRoute
      ...
      <Route
        path="/pages/Configuration/F2Criteria"
        element={
          <ProtectedRoute
            element={<F2Criteria />}
            allowedRoles={["superadmin"]}
      ...
      <Route
        path="/pages/Configuration/AddF2Criteria"
        element={
          <ProtectedRoute
            element={<AddF2Criteria />}
            allowedRoles={["superadmin"]}
          />
        }
      />
      ...
      <Route
        path="/pages/Configuration/F2CriteriaInfo"
        element={
          <ProtectedRoute
